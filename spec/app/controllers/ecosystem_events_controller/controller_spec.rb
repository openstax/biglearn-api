...
RSpec.describe EcosystemEventsController, type: :request do
  context '#fetch' do
    ...
    let(:given_event_types_1)            do
      EcosystemEvent.event_types.keys.sample(rand(EcosystemEvent.event_types.size) + 1)
    end
    ...
    let(:target_event_type_1)           { EcosystemEvent.event_types.keys.sample }
    ...
    let(:target_event_type_2)           { EcosystemEvent.event_types.keys.sample }
