...
RSpec.describe ExerciseExclusionsController, type: :request do
  context '#update_course_excluded_exercises' do
    ...
    before(:each) do
      allow(Services::UpdateCourseExerciseExclusions::Service).to(
    ...
    context "when a valid request is made" do
      it "the request and response payloads are validated against their schemas" do
        ...
        response_status, response_body = update_course_excluded_exercises(
