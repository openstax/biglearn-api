...
RSpec.describe CourseEcosystemsController, type: :request do
  context '#prepare' do
    ...
    let(:given_prepared_at)             { Time.current.iso8601(6) }
  ...
  context '#update' do
    ...
    let(:given_updated_at_1)       { Time.current.iso8601(6) }
    ...
    let(:given_updated_at_2)       { Time.current.iso8601(6) }
